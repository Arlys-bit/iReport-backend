...
### Start locally with npm (Windows)

If you prefer using npm and Expo, follow these steps in **Command Prompt** (recommended to avoid PowerShell execution policy issues):

1) Change to the project directory:

   cd "C:\Users\Arl\OneDrive\Documents\dis"

2) Install dependencies:

   npm install

3) Start the dev server (recommended):
...
If `npm` or `npx` are not found, install Node.js LTS from https://nodejs.org and re-open your terminal.
