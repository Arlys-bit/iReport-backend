    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity onPress={handleBack} style={{ marginLeft: 8, paddingRight: 8 }}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>{report.location || 'Not specified'}</Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            <View style={styles.infoLabel}>
              ...
              <Text style={styles.infoLabelText}>Incident Date & Time</Text>
            </View>
            <Text style={styles.infoValue}>
              ...
              <View key={history.id} style={styles.timelineItem}>
                ...
                <View style={styles.timelineContent}>
                  <Text style={styles.timelineAction}>
                    {(history.action || 'unknown').replace(/_/g, ' ')}
                  </Text>
                  {history.notes && (
